...
public class TcpClientsPerRequest extends ClientsProvider {

    @NotNull
    private final static Logger logger = Logger.getLogger(TcpClientsPerRequest.class);

    public TcpClientsPerRequest(@NotNull final String host, int port, int N, int M, long delta, int X) {
